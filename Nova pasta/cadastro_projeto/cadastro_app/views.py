...
from .models import Resposta, Professor, Aluno, UsuarioPersonalizado, Curso, QuestaoTeste
...
def resultados_por_pergunta(request):
    ...
    return render(request, 'cadastro_app/resultados_por_pergunta.html', {'resultados': resultados})
@login_required
def home(request):
